...
import { Button, Img, Text, Heading, Input, CheckBox } from "../../components";
        ...
        <div className="flex flex-row justify-start px-6 w-full">
          <div className="flex flex-col gap-8 items-center justify-start w-full">
            ...
            <div className="flex flex-row gap-5 items-start w-full">
              <div className="bg-white-A700 flex flex-row justify-start mb-14 p-8 rounded shadow-xs w-[67%]">
                <div className="flex flex-col gap-12 items-center justify-start mb-[202px] w-full">
                  ...
                  <div className="flex flex-col items-center justify-start w-full">
                    ...
                    <div className="bg-indigo-50 h-px mt-[33px] w-full" />
                    <div className="flex flex-col gap-6 items-center justify-start mt-8 w-full">
                      <div className="flex flex-col gap-2.5 items-start justify-start w-full">
                        ...
                        <Input
                          ...
                          prefix={
                            <Img
                              src="images/img_icon_blue_gray_900_20x20.svg"
                              alt="Icon "
                              className="mr-4"
                            />
                          }
