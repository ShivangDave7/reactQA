...
export default function CalendarDay1EventPage() {
  return (
              ...
              >
                <div className="flex flex-row justify-between w-full">
                  ...
                  <TabList className="flex flex-row justify-between p-2.5 w-auto">
                    <Tab className="font-semibold ml-3.5 text-center text-sm text-white-A700">
                      Day
                    </Tab>
                ...
                {[...Array(3)].map((_, index) => (
                  ...
                  >
                    <div className="flex flex-col items-center justify-start py-3 w-full">
                      <div className="flex flex-col gap-2 items-center justify-start mb-[544px] w-full">
                        ...
                        <div className="bg-indigo-400 flex flex-row justify-start p-1 rounded w-full">
                          <div className="flex flex-row justify-start ml-3 pr-1.5 w-[31%]">
                            <div className="flex flex-row items-start justify-between pb-[3px] w-full">
                              <Img
                                src="images/img_oval_white_a700.svg"
                                alt="oval"
                                className="h-2 mt-[7px]"
                              />
                              <Text
                                size="lg"
                                as="p"
