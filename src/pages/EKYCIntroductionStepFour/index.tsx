...
export default function EKYCIntroductionStepFourPage() {
  return (
    <div className="bg-gray-100_06 flex flex-row items-start w-full">
              ...
              <div className="flex flex-col gap-[59px] items-center justify-start w-[46%]">
                ...
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="flex flex-col gap-5 w-full">
                    <div className="bg-white-A700 border border-indigo-50 border-solid cursor-pointer flex flex-row justify-start p-[25px] rounded hover:shadow-bs1 shadow-md w-full">
                    ...
                    <div className="border border-indigo-50 border-solid cursor-pointer flex flex-row justify-start p-[25px] rounded hover:shadow-bs1 shadow-md w-full">
                      <div className="flex flex-row gap-6 items-center justify-start ml-[7px] w-[97%]">
                        <div className="flex flex-row gap-5 items-center w-[88%]">
                          <Img
                            src="images/img_01_navigation_blue_gray_800.svg"
                            alt="01navigation"
                            className="h-7 w-7"
                          />
                          <div className="flex flex-col gap-[9px] items-start justify-end w-[86%]">
                      ...
                      <div className="flex flex-row gap-6 items-center justify-start ml-[7px] w-[97%]">
                        <div className="flex flex-row gap-5 items-center w-[88%]">
                          <div className="h-[30px] relative w-[9%]">
                            <Img
                              src="images/img_02_essential_blue_gray_800.svg"
                              alt="02essential"
                    ...
                    <div className="bg-white-A700 cursor-pointer flex flex-row justify-start p-[25px] rounded hover:shadow-bs1 shadow-md w-full">
                      <div className="flex flex-row gap-6 items-center justify-start ml-[7px] w-[97%]">
                        <div className="flex flex-row gap-5 items-center w-[88%]">
                          <Img
                            src="images/img_02_essential_deep_orange_300_28x28.svg"
                            alt="02essential"
                            className="h-7 w-7"
                          />
